...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Create 'Name' 'Type' 'IsWeighted' - Creates a new gradebook where 'Name' is the name of the gradebook and 'Type' is what type of grading it should use and where 'IsWeighted' if it's weighted or not (true / false).");
            Console.WriteLine();
